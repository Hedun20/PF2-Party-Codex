export const plannedIndexes = [
  ...
  { collection: "characters", keys: { campaignId: 1, ownerUserId: 1 } },
  { collection: "maps", keys: { campaignId: 1, worldId: 1 } },
  { collection: "mapObjects", keys: { campaignId: 1, mapId: 1, visibility: 1 } },
  { collection: "timelineEvents", keys: { campaignId: 1, sortIndex: 1 } },
