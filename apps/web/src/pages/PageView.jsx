  ...
  return (
    <section className="codex-card article-notes-panel article-notes-panel-v2">
          ...
          {linkedNotes.slice(0, 5).map((note) => (
            <article key={note.id} className="article-note-row">
              ...
              <div className="article-note-actions">
                ...
                <CodexButton type="button" variant="danger" size="sm" onClick={() => removeArticleNote(note)} disabled={busy}><Trash2 size={14} /> <span>Delete</span></CodexButton>
              </div>
            </article>
          ))}
        </div>
      ...
      <div className="article-notes-actions">
        <CodexButton type="button" size="sm" onClick={addArticleNote} disabled={busy}><Plus size={15} /> <span>Add note</span></CodexButton>
