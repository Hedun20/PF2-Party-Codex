      ...
      {!items.length && (
        <section className="empty-missing-state">
          ...
          <div>
            ...
            <p>Это хороший знак: активная кампания не содержит ссылок на несуществующие статьи. Чтобы проверить механику, добавь в любую статью ссылку формата `[[Название будущей статьи]]`.</p>
          </div>
        </section>
      )}
    </div>
